module Spree
  module FrontendHelper
    ...
    def lazy_image(src:, alt:, width:, height:, srcset: '', style: nil, **options)
      ...
      image_tag placeholder, data: { src: src, srcset: srcset }, class: "#{options[:class]} lazyload", alt: alt, style: style
    end
